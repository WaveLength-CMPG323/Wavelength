  ...
  return (
        ...
        <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl flex-col">
          ...
          <div className="flex flex-1 flex-col items-center justify-center text-center">
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
              Enter a living ocean of music, meet listeners who share your
              taste, and find your next favourite song.
            </p>
            <button
                type="button"
                className="mt-8 inline-flex min-h-12 items-center justify-center gap-3 rounded-full bg-[#1ED760] px-7 py-3 font-semibold text-black transition-colors hover:bg-[#1fdf64] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#1ED760]"
            >
    ...
    <footer className="border-t border-cyan-500/20 bg-[#02182b] px-6 py-8">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 text-sm text-slate-400 sm:flex-row">
            ...
            <a className="hover:text-cyan-300" href="/terms">
                Terms of Use
            </a>

            <a className="hover:text-cyan-300" href="/data-processing">
                POPIA Data Processing Notice
            </a>
            </nav>
        </div>
    </footer>
