...
export default function NavPanel({ open, onClose, title, children, wide }: NavPanelProps) {
  return (
    <AnimatePresence>
      {open && (
        <motion.div
        ...
        >
          <motion.div
            ...
            className={`flex max-h-[85vh] w-full flex-col overflow-hidden rounded-2xl border border-cyan-500/20 bg-[#04385a] shadow-2xl ${wide ? 'max-w-md' : 'max-w-sm'}`}
